...
String decoded_text = "";
String mode_names[5] = {"Keyer", "TRX", "Koch Trainer", "Koch New Lesson", "Echo Trainer"};
...
void openSettingsMenue()
{
  ...
  { // loop until a valid selection is made
    ...
    for (int i = 0; i < numMenuItems; i++)
    {
      ...
      if (i < (numMenuItems - 1))
      { // if not exit, print setting value
        M5.Lcd.print(": ");
    ...
    { // if the A button was pressed
      ...
      if (menuSelection == numMenuItems - 1)
...
void openMenu()
{
  ...
  { // loop until a valid selection is made
    ...
    { // if the A button was pressed
      ...
      else if (menuSelection == numMenuItems - 2)
      { // if the "Settings Menu" item is selected
        openSettingsMenue();
      }
      else if (menuItems[menuSelection] == "Keyer Mode")
      { // if the "Keyer Mode" is selected,
        btStop();
      ...
      else if (menuItems[menuSelection] == "Koch Trainer Mode")
      { // if the "Koch Trainer Mode" is selected
        btStop();
        mode = menuSelection; // set the mode based on the selected menu item
        M5.Lcd.fillScreen(BLACK);
        ; // clear the screen
      ...
      else if (menuItems[menuSelection] == "Koch New Lesson Mode")
      { // if the "Koch New Lesson Mode" is selected
        btStop();
        mode = menuSelection; // set the mode based on the selected menu item
        M5.Lcd.fillScreen(BLACK);
        ; // clear the screen
      ...
      else if (menuItems[menuSelection] == "Echo Trainer Mode")
      { // if the "Echo Trainer Mode" is selected
        btStop();
        mode = menuSelection; // set the mode based on the selected menu item
        M5.Lcd.fillScreen(BLACK);
        ; // clear the screen
